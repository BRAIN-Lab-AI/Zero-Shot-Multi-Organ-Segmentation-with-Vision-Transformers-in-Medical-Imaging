...
def main():
    ...
    for epoch in range(args.num_epochs):
        ...
        if val_dataloader:
            ...
            if val_loss < best_val_loss:
                ...
                model_save_path = os.path.join(drive_save_path, "frozen_2_50-60-NN_MedSAM-Baseline_best.pth")
    ...
    plot_save_path = os.path.join(drive_save_path, "frozen_2_baseline_loss_curve.png")
